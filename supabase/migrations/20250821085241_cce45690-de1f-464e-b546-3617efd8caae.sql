-- Simple data population to enhance reports (avoiding conflicts)

-- First, let's add some basic sample data that won't conflict
...
-- Generate agreements using the function for unique numbers
...
SELECT 
  ...
  (ARRAY['Minor scratch', 'Dent on bumper', 'Engine service', 'Windshield repair', 'Tire change', 'Interior cleaning'])[floor(random() * 6 + 1)],
