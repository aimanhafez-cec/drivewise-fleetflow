...
CREATE TYPE public.condition_report_cadence AS ENUM ('On start', 'On swap', 'Monthly', 'On start and swap');
...
CREATE TABLE public.car_subscriptions (
    ...
    condition_report_cadence condition_report_cadence NOT NULL DEFAULT 'On start and swap',
