  ...
  const getFullRequestData = (requestId: string) => {
    const fullDataMap: Record<string, any> = {
      ...
      'LR-2025-1842': {
        ...
        refuelNotes: 'Vehicle refueled and returned to fleet. Tank filled to 100% (68 liters). Fleet card transaction completed successfully.',
        ...
        windowFrom: '14:00',
        windowTo: '15:30',
        internalNotes: 'COMPLETED: Vehicle refueled successfully at ENOC Station 24. Departed at 2:15 PM, refueled 2:35-2:45 PM (68L Special 95), returned to Dubai Marina Branch at 3:10 PM. Fleet card charged AED 280. Vehicle now available in fleet.',
