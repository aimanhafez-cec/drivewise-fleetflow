        ...
        <Accordion type="multiple" value={[...accordionValues, ...validation.expandedAccordions]} onValueChange={setAccordionValues} className="space-y-4">
          ...
          <AccordionItem value="rental-info" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-card-foreground">Rental Information</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6">
              <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="space-y-2">
                  <Label htmlFor="reservationNo" className="text-card-foreground">Reservation no.</Label>
                ...
                {/* Entry Date */}
                <div className="space-y-2">
                  <Label className="text-card-foreground">Reservation Entry Date <span className="text-destructive">*</span></Label>
                ...
                {/* Currency */}
                <div className="space-y-2">
                  <Label className="text-card-foreground">Currency <span className="text-destructive">*</span></Label>
                ...
                <div className="space-y-2">
                  <Label className="text-card-foreground">Customer <span className="text-destructive">*</span></Label>
                  <Popover open={customerSearchOpen} onOpenChange={setCustomerSearchOpen}>
                    <PopoverTrigger asChild>
                      <Button variant="outline" role="combobox" aria-expanded={customerSearchOpen} className={cn("w-full justify-between text-card-foreground", !formData.customerId && "text-card-foreground", errors.customerId && "border-destructive")}>
                ...
                {/* Validity Date To */}
                <div className="space-y-2">
                  <Label className="text-card-foreground">Validity Date To</Label>
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button variant="outline" className={cn("w-full justify-start text-left font-normal text-card-foreground", !formData.validityDateTo && "text-card-foreground", validation.getFieldError('header.validityDateTo') && "border-destructive")}>
                        <CalendarIcon className="mr-2 h-4 w-4" />
                ...
                <div className="space-y-2">
                  <Label className="text-card-foreground">Contract Billing Plan</Label>
                ...
                {/* Tax Level */}
                <div className="space-y-2">
                  <Label className="text-card-foreground">Tax Level</Label>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="lease-to-own" className="text-card-foreground">Lease to Own</Label>
                  </div>
                </div>
              </div>
            </AccordionContent>
          ...
          <AccordionItem value="billing" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-card-foreground">Bill To</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6">
          ...
          <AccordionItem value="vehicles-drivers" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-card-foreground">Vehicle & Driver</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6">
              <Tabs defaultValue="vehicles" className="w-full">
                <TabsList className="grid w-full grid-cols-2 mb-4 bg-muted">
                  <TabsTrigger value="vehicles" className="text-muted-foreground data-[state=active]:bg-background data-[state=active]:text-card-foreground font-medium">Vehicle Information</TabsTrigger>
                  <TabsTrigger value="drivers" className="text-muted-foreground data-[state=active]:bg-background data-[state=active]:text-card-foreground font-medium">Driver Information</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="vehicles" className="space-y-6">
                  <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
                    {/* Dates */}
                    <div className="space-y-2">
                      <Label className="text-card-foreground">Check Out Date <span className="text-destructive">*</span></Label>
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button variant="outline" className={cn("w-full justify-start text-left font-normal text-card-foreground", !formData.checkOutDate && "text-card-foreground")}>
                            <CalendarIcon className="mr-2 h-4 w-4" />
                    ...
                    <div className="space-y-2">
                      <Label className="text-card-foreground">Check In Date <span className="text-destructive">*</span></Label>
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button variant="outline" className={cn("w-full justify-start text-left font-normal text-card-foreground", !formData.checkInDate && "text-card-foreground")}>
                            <CalendarIcon className="mr-2 h-4 w-4" />
                    ...
                    <div className="md:col-span-2">
                      <div className="space-y-2">
                        <Label className="text-card-foreground">Specific Vehicle <span className="text-white">(Optional - leave empty to assign later in agreement)</span></Label>
          ...
          <AccordionItem value="airport-info" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-card-foreground">Airport Information</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6">
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="enable-airport-info" className="text-card-foreground">Enable Airport Information</Label>
                </div>

                {formData.enableAirportInfo && <>
                    {/* Arrival Information */}
                    <div>
                      <h4 className="font-medium mb-4 text-card-foreground">Arrival Information</h4>
                      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        <div className="space-y-2">
                          <Label className="text-card-foreground">Flight No.</Label>
                        ...
                        <div className="space-y-2">
                          <Label className="text-card-foreground">Date & Time</Label>
                          <Popover>
                            <PopoverTrigger asChild>
                              <Button variant="outline" className={cn("w-full justify-start text-left font-normal text-card-foreground", !formData.arrivalDateTime && "text-card-foreground")}>
                                <CalendarIcon className="mr-2 h-4 w-4" />
                        ...
                        <div className="space-y-2">
                          <Label className="text-card-foreground">Airline</Label>
                        ...
                        <div className="space-y-2">
                          <Label className="text-card-foreground">Airport</Label>
                        ...
                        <div className="space-y-2">
                          <Label className="text-card-foreground">Passengers</Label>
                    ...
                    <div>
                      <h4 className="font-medium mb-4 text-card-foreground">Departure Information</h4>
                      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        <div className="space-y-2">
                          <Label className="text-card-foreground">Flight No.</Label>
                        ...
                        <div className="space-y-2">
                          ...
                          <Popover>
                            <PopoverTrigger asChild>
                              <Button variant="outline" className={cn("w-full justify-start text-left font-normal text-card-foreground", !formData.departureDateTime && "text-card-foreground")}>
                                <CalendarIcon className="mr-2 h-4 w-4" />
                ...
                {!formData.enableAirportInfo && <div className="text-sm text-card-foreground bg-muted/50 p-4 rounded-lg">
          ...
          <AccordionItem value="insurance" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-card-foreground">Insurance Information</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6">
              <div className="grid gap-4 grid-cols-1 md:grid-cols-3">
                <div className="space-y-2">
                  <Label className="text-card-foreground">Insurance Level</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-card-foreground">Insurance Group</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-card-foreground">Insurance Provider</Label>
          ...
          <AccordionItem value="misc-charges" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-card-foreground">Miscellaneous Charges</span>
          ...
          <AccordionItem value="rate-taxes" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-card-foreground">Rate & Taxes</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6">
              <div className="space-y-6">
                <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label className="text-card-foreground">Price List</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-card-foreground">Promotion Code</Label>
                ...
                <div className="space-y-4">
                  <h4 className="font-medium text-card-foreground">Rates</h4>
                  <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                    <div className="space-y-2">
                      <Label className="text-card-foreground">Hourly Rate</Label>
                    ...
                    <div className="space-y-2">
                      <Label className="text-card-foreground">Daily Rate</Label>
                    ...
                    <div className="space-y-2">
                      <Label className="text-card-foreground">Weekly Rate</Label>
                    ...
                    <div className="space-y-2">
                      <Label className="text-card-foreground">Monthly Rate</Label>
                ...
                <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label className="text-card-foreground">Kilometer Charge</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-card-foreground">Daily Kilometer Allowed</Label>
          ...
          <AccordionItem value="adjustments-deposits" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                <DollarSign className="h-5 w-5" />
                <span className="font-semibold text-card-foreground">Adjustments & Deposits</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6">
              <div className="space-y-6">
                <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                  <div className="space-y-2">
                    <Label className="text-card-foreground">Pre-adjustment</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-card-foreground">Advance Payment</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-card-foreground">Security Deposit Paid</Label>
                ...
                {formData.advancePayment > 0 && <div className="space-y-4 p-4 border rounded-lg bg-muted/50">
                    <h4 className="font-medium text-card-foreground">Payment Method (Required for Advance Payment)</h4>
                    <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                      <div className="space-y-2">
                ...
                {formData.securityDepositPaid > 0 && <div className="space-y-4 p-4 border rounded-lg bg-muted/50">
                    <h4 className="font-medium text-card-foreground">Deposit Payment Details (Required for Security Deposit)</h4>
                    <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                      <div className="space-y-2">
          ...
          <AccordionItem value="referral-info" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-card-foreground">Referral Information - Loyalty Program</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6">
              <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
                <div className="space-y-2">
                  <Label className="text-card-foreground">Referred by Customer</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-card-foreground">Referral Code</Label>
          ...
          <AccordionItem value="notes" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-card-foreground">Notes</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6">
              <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-card-foreground">{(formData.note || '').length}/500 characters</p>
                </div>
                <div className="space-y-2">
                  <Label className="text-card-foreground">Special Note</Label>
                  ...
                  <p className="text-xs text-card-foreground">{(formData.specialNote || '').length}/500 characters</p>
                </div>
              </div>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="reservation-lines" className="border rounded-lg">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-2">
                <Car className="h-5 w-5" />
                <span className="font-semibold text-card-foreground">Reservation Lines</span>
