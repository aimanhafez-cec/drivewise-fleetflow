                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center justify-between">
                                <div className="text-lg font-bold text-primary">
                                  AED {cost.toFixed(0)}
                                  {addOn.isFlat ? (
                                    <span className="text-xs text-muted-foreground ml-1">(flat rate)</span>
                                  ) : (
            ...
            {selectedAddOns.length === 0 ? (
              ...
              <div className="space-y-3">
                {selectedAddOns.map((addOnId) => {
                  ...
                  return (
                    <div key={addOnId} className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-sm">AED {cost.toFixed(0)}</p>
                        <Button
                          variant="ghost"
                          size="sm"
