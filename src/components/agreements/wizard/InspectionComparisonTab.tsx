        ...
        <CardHeader>
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            <div className="flex-1">
              <CardTitle className="text-xl lg:text-2xl">Damage Report</CardTitle>
              <CardDescription className="mt-2">
                Comparison of vehicle condition between check-out and check-in inspections
              </CardDescription>
            </div>
      ...
      <Card>
        <CardContent className="pt-6">
          <Alert>
            ...
            <AlertDescription>
              Financial charges and settlement details will be calculated in the Financial Settlement step.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
