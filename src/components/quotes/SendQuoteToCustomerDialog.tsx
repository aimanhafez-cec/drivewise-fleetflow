...
import { useSendQuoteToCustomer } from "@/hooks/useQuote";

interface SendQuoteToCustomerDialogProps {
  open: boolean;
...
export const SendQuoteToCustomerDialog: React.FC<SendQuoteToCustomerDialogProps> = ({
  open,
  onOpenChange,
  quoteId,
  quoteNumber,
  ...
  const sendMutation = useSendQuoteToCustomer();
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          ...
          <DialogDescription>
            The customer will receive a secure link to review and digitally sign the quote.
          </DialogDescription>
        </DialogHeader>
