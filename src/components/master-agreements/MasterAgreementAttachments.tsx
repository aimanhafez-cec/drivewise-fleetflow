...
interface MasterAgreementAttachmentsProps {
  agreementId?: string;
}
...
export const MasterAgreementAttachments: React.FC<MasterAgreementAttachmentsProps> = ({ agreementId }) => {
  ...
  const {
    ...
    downloadFile,
  } = useMasterAgreementAttachments(agreementId);
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {/* Save Button */}
          <Button onClick={handleSave} disabled={isAddingAttachment || !agreementId}>
            {isAddingAttachment ? (
              <>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-sm mt-1">Add supporting documents, images, or links to this master agreement</p>
            </div>
          ) : (
